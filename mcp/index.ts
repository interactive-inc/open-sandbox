...
import { docsReadProductFeatures } from "./tools/docs-read-product-features"
...
import { docsWriteProductFeature } from "./tools/docs-write-product-feature"
...
const tools = [
  ...
  docsReadFiles,
  docsReadOverview,
  docsReadProductFeatures,
  docsReadProductRoutes,
  docsReadProductOverview,
  // Write
  docsWriteFile,
  docsWriteOverview,
  docsWriteProductFeature,
