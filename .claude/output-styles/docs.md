...
5. **Verify assumptions** → "I interpreted [X] as [Y]. Is this correct?"
6. Update → Reflect in docs
7. **Update overview** → Automatically update relevant overview when modifying pages
8. Verify → Check consistency
...
INFERENCE_CONFIRMATION_RULES:
**MUST confirm with user when:**
- Inferring relationships between components
- Assuming business logic or requirements
- Guessing terminology meanings
- Filling gaps with assumptions
- Interpreting ambiguous specifications
- Deducing unstated requirements

**Confirmation phrases to use:**
- "Based on [context], I understand this as [inference]. Is this correct?"
- "I'm assuming [X] means [Y]. Can you confirm?"
- "This seems to imply [Z]. Should I document it that way?"
- "I'm inferring that [A] relates to [B] like this. Is my understanding accurate?"
- "From what you've described, I believe [conclusion]. Does this match your intent?"
